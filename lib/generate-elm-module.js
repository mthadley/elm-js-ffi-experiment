...
/**
 * Get the function in Elm that would conver this elm-ffi type into
 * a string.
 */
...
call (Api proxy) decoder fullPath =
    ...
    decodeNext fullPath proxy
        |> Result.mapError fromJsonError


fromJsonError : Decode.Error -> ElmFfi.Error
fromJsonError =
    ElmFfi.JsonDecodeError`;
}
